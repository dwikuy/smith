...
$headers[] = 'X-AppVersion: 3.39.1';
$headers[] = "X-Uniqueid: 3cad4b687b6af".rand(111,999);
$headers[] = 'X-Location: -6.1823119,106.8014452';
        echo "\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\e[31m|           RECODE BY DWIKUYZ SMITH              |\n";
        echo "\e[35m|         Recode doesn't make you a pro          |\n";
        echo "\e[32m|         Thanks to Netwezen,SGB,LODONK          |\n";
        ...
        $nama = nama();
        $nama1 = 'Ardy';
        $email = strtolower(str_replace(" ", "", $nama) . mt_rand(100,999) . "@mailnesia.com");
...
echo "\e[91m [×] Gagal Claim Voucer !";
                ...
                sleep(5);
                echo "\n";
                echo "\e[96m[+] Mencoba Redeem Vocher : PESANGOFOODYUK \n";
                $data7 = '{"promo_code":"PESANGOFOODYUK"}';
...
function request($url, $token = null, $data = null, $pin = null, $otpsetpin = null, $uuid = null)
    ...
    $header[] = "X-Uniqueid: ".time()."04".mt_rand(1000,9999);
    $header[] = "Connection: keep-alive";
    $header[] = "X-User-Locale: id_ID";
    $header[] = "X-Location: -6.1823119,106.8014452";
